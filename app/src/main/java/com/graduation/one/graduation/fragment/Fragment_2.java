...
public class Fragment_2 extends android.support.v4.app.Fragment {
    ...
    private Fragment_2.MyAdapter adapter;
    private SwipeRefreshLayout mSwipeLayout;
    private SharedPreferences editor;
    private Button chaxun;
    public View view;
    private int a = 0, b = 0;
    private Fragment_2.MyAdapter1 adapter1;
    ...
    private void initView(View view) {
        ...
        adapter = new Fragment_2.MyAdapter();
        adapter1 = new Fragment_2.MyAdapter1();
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            Fragment_2.ViewHolder viewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_message, parent, false);
                viewHolder = new Fragment_2.ViewHolder();
                ...
                viewHolder = (Fragment_2.ViewHolder) convertView.getTag();
            }
    ...
    class MyAdapter1 extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder1 = (Fragment_2.ViewHolder1) convertView.getTag();
            }
